...
%>						
					<h3 class="title">조치계획  작성</h3>
<%
}else{
%>
					<h3 class="title">조치계획  조회</h3>
<%
}
%>							
				</div>	
...
%>
											...
											<td colspan="5">
												<textarea id="cas_dtl_cntn" name="cas_dtl_cntn" cols="20" rows="5" class="textarea" readonly><%=StringUtil.htmlEscape((String)hActDtlMap.get("cas_dtl_cntn"),false,false)%></textarea>
											</td>	
<%
}else{
...
%>		
											<td colspan="5">
												<textarea id="cas_dtl_cntn" name="cas_dtl_cntn" cols="20" rows="5" class="textarea"><%=StringUtil.htmlEscape((String)hActDtlMap.get("cas_dtl_cntn"),false,false)%></textarea>
												<div id="place_hidden_1" class="form-control" style="display:none;height:115.5px;" >
													<div id="place_hidden_1" style="opacity:0.7"><span id="place_hidden_1" style="color:#FF73BE">"예금주 성명"</span>, <span id="place_hidden_1" style="color:#FF73BE">"계좌번호"</span>,<span id="place_hidden_1" style="color:#FF73BE">"카드번호"</span>등의 개인정보는 <span id="place_hidden_1" style="color:#FF73BE">마스킹</span> 처리하여 입력부탁드립니다.</div>
													<div id="place_hidden_1" style="opacity:0.7">예)김**, 301-****-****-11, 011-****-****-31, 94**-****-****-73 등</div>
												</div>
											</td>
<%
	}else{
...
%>											
											<td colspan="5">
												<textarea id="cft_plan_cntn" name="cft_plan_cntn" cols="20" rows="5" class="textarea" readonly ><%=StringUtil.htmlEscape((String)hActDtlMap.get("cft_plan_cntn"),false,false)%></textarea>
											</td>
<%
}else{
	if(hd_brc.equals(hd_apl_brc)){
%>
											<td colspan="5">
												<textarea id="cft_plan_cntn" name="cft_plan_cntn" cols="20" rows="5" class="textarea" ><%=StringUtil.htmlEscape((String)hActDtlMap.get("cft_plan_cntn"),false,false)%></textarea>
												<div id="place_hidden_2" class="form-control" style="display:none;height:115.5px;" >
													<div id="place_hidden_2" style="opacity:0.7"><span id="place_hidden_2" style="color:#FF73BE">"예금주 성명"</span>, <span id="place_hidden_2" style="color:#FF73BE">"계좌번호"</span>,<span id="place_hidden_2" style="color:#FF73BE">"카드번호"</span>등의 개인정보는 <span id="place_hidden_2" style="color:#FF73BE">마스킹</span> 처리하여 입력부탁드립니다.</div>
													<div id="place_hidden_2" style="opacity:0.7">예)김**, 301-****-****-11, 011-****-****-31, 94**-****-****-73 등</div>
												</div>
											</td>
<%
	}else{
...
%>											
											<td colspan="5">
												<textarea id="exe_rzt_cntn" name="exe_rzt_cntn" cols="20" rows="5" class="textarea" readonly ><%=StringUtil.htmlEscape((String)hActDtlMap.get("exe_rzt_cntn"),false,false)%></textarea>
											</td>
<%
}else{
	if(hd_brc.equals(hd_apl_brc)){
%>
											<td colspan="5">
												<textarea id="exe_rzt_cntn" name="exe_rzt_cntn" cols="20" rows="5" class="textarea" ><%=StringUtil.htmlEscape((String)hActDtlMap.get("exe_rzt_cntn"),false,false)%></textarea>
												<div id="place_hidden_3" class="form-control" style="display:none;height:115.5px;" >
													<div id="place_hidden_3" style="opacity:0.7"><span id="place_hidden_3" style="color:#FF73BE">"예금주 성명"</span>, <span id="place_hidden_3" style="color:#FF73BE">"계좌번호"</span>,<span id="place_hidden_3" style="color:#FF73BE">"카드번호"</span>등의 개인정보는 <span id="place_hidden_3" style="color:#FF73BE">마스킹</span> 처리하여 입력부탁드립니다.</div>
													<div id="place_hidden_3" style="opacity:0.7">예)김**, 301-****-****-11, 011-****-****-31, 94**-****-****-73 등</div>
												</div>
											</td>
<%
	}else{
...
%>											
					...
					<div class="box box-grid" style="display:none;">
						<div class="box">
							<div class="wrap">
								<div class="box grid">
									<!-- /.box-header -->
									<div class="box-body">
										<div class="wrap-grid scroll" style="height:200px;">
										</div>
									<!-- .wrap //-->
									</div>
									<!-- /.box-body -->
									...
									<div class="p_foot text-center">
					<div class="btn-wrap center">
<% 
if(auth.equals("003") && (act_dcz_stsc.equals("") || act_dcz_stsc.equals("01"))){
%>						
						<button class="btn btn-default" type="button" onclick="javascript:doAction('save');">저장</button>
