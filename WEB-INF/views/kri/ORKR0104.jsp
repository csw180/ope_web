...
/*---------------------------------------------------------------------------
 ...
 Program name : KRI허용한도 관리 상세
 Description  : 화면정의서 KRI-01.2.1
 Programer    : 정현식
...
<head>
	...
	function setForm1() {
		...
		WP.setParameter("process_id", "ORKR010402"); //KRI허용한도관리상세조회1
	...
	function setForm2() {
		...
		WP.setParameter("method", "Main");
		WP.setParameter("commkind", "kri");
		WP.setParameter("process_id", "ORKR010403"); //KRI허용한도관리상세조회1
	...
	function setForm3() {
		...
		WP.setParameter("method", "Main");
		WP.setParameter("commkind", "kri");
		WP.setParameter("process_id", "ORKR010404"); //KRI허용한도관리상세조회1
	...
	function initIBSheet() {
		...
		initData.Cols = [
			...
			{Type:"Text",Width:150,Align:"Left" ,SaveName:"chg_cntn"		,MinWidth:60,Edit:false},
		];
	...
	function doAction(sAction) {
		switch(sAction) {
			case "search":  //데이터 조회
				...
				$("form[name=ormsForm] [name=process_id]").val("ORKR010405");
	...
	function endORKR3101(){
		...
		WP.setParameter("method", "Main");
		WP.setParameter("commkind", "kri");
		WP.setParameter("process_id", "ORKR010406");
		WP.setForm(f);
