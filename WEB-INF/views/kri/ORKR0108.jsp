...
<%
	...
	System.out.println("p_mntr_st_dt --> " + p_mntr_st_dt);
...
<head>
	...
	function initParam(addOrMod) {
		...
		if(addOrMod == "mod"){
			...
			f.bas_y.value 		= "<%=max_bas_ym %>".substring(0,4);
	...
	function save(){
		...
		WP.setParameter("process_id", "ORKR010707");
		WP.setForm(f);
	...
	function delSchedule(){
		...
		WP.setParameter("method", "Main");
		WP.setParameter("commkind", "kri");
		WP.setParameter("process_id", "ORKR010708");
		WP.setForm(f);
									...
									<tr>
										...
										<td colspan="1" class="form-inline">
											<div class="input-group">
												<input type="text" name="bas_y" id="bas_y" class="form-control w100" readonly />
											</div>
										</td>									
										<th>회차</th>
										<td colspan="1" class="form-inline">
