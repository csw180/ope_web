...
<html lang="ko">
	...
	<body style="background-color:transparent">
		<div id="" class="popup modal block" style="background-color:transparent">
				<div class="p_frame w1100">
					...
					<div class="p_body">
						...
						<div class="p_wrap">
							...
							<div class="wrap-table in_bdr th_bg th_c td_c col lr_none">
								<table>
							...
							<h5 class="title mt30 mb10">&lt;손실형태 분류기준&gt;</h5>
							<div class="box text-centerline p20">
