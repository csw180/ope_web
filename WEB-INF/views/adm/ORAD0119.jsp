<%--
/*---------------------------------------------------------------------------
 Program ID   : ORAD0119.jsp
 Program name : ADMIN > 사용자/권한관리 > 프로그램 권한 조회
 Description  : 
 Programer    : 권성학
		...
		<script>
			...
			function initIBSheet() {
				...
				initData.Cols = [
					...
					{Header:"삭제",Type:"DelCheck",Width:80,Align:"Center",SaveName:"del_check",MinWidth:40},		    
				    {Header:"그룹기관코드",Type:"Text",Width:80,Align:"Left",SaveName:"grp_org_c",MinWidth:60, Hidden:true,Edit:false},				    
					...
					{Header:"프로그램ID",Type:"Text",Width:350,Align:"Left",SaveName:"pgid",MinWidth:40, Edit:false},
					...
					{Header:"프로그램ID(신)",Type:"Text",Width:450,Align:"Left",SaveName:"new_pgid",MinWidth:40, Wrap:true}
				];
			...
			function doAction(sAction) {
				switch(sAction) {
					case "search":  //데이터 조회
						...
						$("form[name=ormsForm] [name=process_id]").val("ORAD011902");
					...
					case "save":	//저장
						...
						mySheet.DoSave("<%=System.getProperty("contextpath")%>/comMain.do?method=Main&commkind=adm&process_id=ORAD011903");
						break;
					
					case "down2excel":
						var params = {ExcelHeaderRowHeight:25, ExcelRowHeight:17, ExcelFontSize:10, FileName : "프로그램권한.xlsx", SheetName : "Sheet1", DownTreeHide:"True", DownCols:"3|4"} ;
