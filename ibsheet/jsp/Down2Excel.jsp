...
%><%
    ...
    try {
        ...
        //====================================================================================================
        //down.setTempRoot("C:/SVN/src/IBSheet7.TestPage");
		...
		**/
		...
		if (fileName.toLowerCase().endsWith(".xlsx") && !"".equals(passWord)) {
			...
			File pFile = new File("C:/encrypt.xlsx");
			FileOutputStream fout = new FileOutputStream(pFile);
			
			//서버 내에 암호화된 엑셀파일을 생성합니다.
			com.ibleaders.ibsheet.excel.ProtectXLSX.encryptXLSX("C:/", passWord, file, fout);
